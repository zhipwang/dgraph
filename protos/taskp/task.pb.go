...
type Query struct {
	...
	UidList *List `protobuf:"bytes,8,opt,name=uid_list,json=uidList" json:"uid_list,omitempty"`
	// Function to generate or filter UIDs.
	SrcFunc      []string            `protobuf:"bytes,9,rep,name=src_func,json=srcFunc" json:"src_func,omitempty"`
	Reverse      bool                `protobuf:"varint,10,opt,name=reverse,proto3" json:"reverse,omitempty"`
	FacetParam   *facetsp.Param      `protobuf:"bytes,11,opt,name=facet_param,json=facetParam" json:"facet_param,omitempty"`
	FacetsFilter *facetsp.FilterTree `protobuf:"bytes,12,opt,name=facets_filter,json=facetsFilter" json:"facets_filter,omitempty"`
}
...
func (m *Query) GetIsAggregator() bool {
	if m != nil {
...
var fileDescriptorTask = []byte{
	...
	,
}
