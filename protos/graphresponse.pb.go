...
type Request_ResultFormat int32

const (
	Request_DEFAULT Request_ResultFormat = 0
	Request_QUADS   Request_ResultFormat = 1
)

var Request_ResultFormat_name = map[int32]string{
	0: "DEFAULT",
	1: "QUADS",
}
var Request_ResultFormat_value = map[string]int32{
	"DEFAULT": 0,
	"QUADS":   1,
}

func (x Request_ResultFormat) String() string {
	return proto.EnumName(Request_ResultFormat_name, int32(x))
}
func (Request_ResultFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorGraphresponse, []int{5, 0}
}
...
type Request struct {
	...
	ResultFormat Request_ResultFormat `protobuf:"varint,5,opt,name=resultFormat,proto3,enum=protos.Request_ResultFormat" json:"resultFormat,omitempty"`
}
...
func (m *Request) GetResultFormat() Request_ResultFormat {
	if m != nil {
...
type Response struct {
	...
	Quads        []string          `protobuf:"bytes,2,rep,name=quads" json:"quads,omitempty"`
	L            *Latency          `protobuf:"bytes,3,opt,name=l" json:"l,omitempty"`
	AssignedUids map[string]uint64 `protobuf:"bytes,4,rep,name=AssignedUids" json:"AssignedUids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	Schema       []*SchemaNode     `protobuf:"bytes,5,rep,name=schema" json:"schema,omitempty"`
}
...
func (m *Response) GetQuads() []string {
	if m != nil {
		return m.Quads
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("protos.Request_ResultFormat", Request_ResultFormat_name, Request_ResultFormat_value)
}
...
func (m *Request) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResultFormat != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintGraphresponse(dAtA, i, uint64(m.ResultFormat))
	}
	return i, nil
}
...
func (m *Request) Size() (n int) {
	...
	if m.ResultFormat != 0 {
		n += 1 + sovGraphresponse(uint64(m.ResultFormat))
	}
	return n
}
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResultFormat", wireType)
			}
			m.ResultFormat = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ResultFormat |= (Request_ResultFormat(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorGraphresponse = []byte{
	...
	,
}
