...
// create a network
function renderNetwork({ nodes, edges, treeView, allNodes, allEdges, containerEl}) {
    var data = {
...
class GraphContainer extends Component {
    constructor(props: Props) {
        ...
        // const [ nodes, edges, labels, nodesIdx, edgesIdx ] = processGraph(props.result);
    ...
    saveGraphRef = (graphEl) => {
      this.refs._graph = graphEl;
    }
    ...
    render() {
        ...
        return (
            <Graph
                ...
                saveGraphRef={this.saveGraphRef}
            />
        );
    }
    ...
    componentDidMount() {
      ...
      const containerEl = this.refs._graph;
